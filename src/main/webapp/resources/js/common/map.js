google.maps.__gjsload__('map', function(_) {
    var sv = function() {
      ...
      , Yv = function(a, b, c, d, e) {
        Xv.call(this, a.T, a.o, a.projection, a.maxZoom, a.name, a.alt, a.ha, a.Ee, a.__gmsd, a.mapTypeId, a.$, a.H, a.W, a.heading, a.ua);
        this.o && this.j.set(Wv(this.H, this.W, this.mapTypeId, this.$, this.__gmsd, b, c, d, e))
    }
      , Zv = function(a, b, c) {
    ...
    Cx.prototype.j = function(a, b, c, d, e, f) {
        ...
        if (k) {
            ...
            e = function() {
                ...
                ea.__gm.bindTo("fontLoaded", jP)) : (a.unbind("svClient"),
                a.set("svClient", null))
            }
            ;
            e();
